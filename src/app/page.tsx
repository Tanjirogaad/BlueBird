...
export default function Login() {
  ...
  useEffect(() => {
    ...
    const checkAuth = async () => {
      ...
      try {
        await axios.get("http://192.168.1.168:4000/api/employee/profile", {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await axios.post(
        "http://192.168.1.168:4000/api/employee/login",
        account,
      );
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-2xl shadow-blue-100/50 border border-white/20 overflow-hidden">
          ...
          <div className="p-8 md:p-10">
            <div className="text-center mb-10">
              <img src="/LOGOBLUEBIRD.png" alt="Blue Bird logo" />
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full pr-12 pl-4 py-3.5 border rounded-xl text-sm text-gray-800 border-gray-200"
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={handleChange}
                    className="w-full pr-12 pl-10 py-3.5 border rounded-xl text-sm text-gray-800 border-gray-200"
                    placeholder="••••••••"
